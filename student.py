...
class Student:
    def __init__(self,root):
        ...
        img = Image.open(r"F:\University Project\Images\Student.png")
        ...
        img1 = Image.open(r"F:\University Project\Images\Student.png")
        ...
        img2 = Image.open(r"F:\University Project\Images\Student.png")
        ...
        img3 = Image.open(r"F:\University Project\Images\Backgroundimg.jpg")
        ...
        main_frame.place(x=20,y=50,width=1530,height=600)


        #--------Left side lavel frame----------

        left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        left_frame.place(x=10,y=10,width=730,height=580)

        img_left = Image.open(r"F:\University Project\Images\studentnew.jpg")
        ...
        dep_combo["values"]=("Select Department","Software Engg","Information Technology","Business Studies","Graphics")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","MAT","ECS","PHY","GD")
        ...
        #--------Right side lavel frame----------

        right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,text="Student Details", font=("times new roman", 12, "bold"))
        right_frame.place(x=750, y=10, width=720, height=580)

        img_right = Image.open(r"F:\University Project\Images\Student.png")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost", username="root",password="Nishu01792@#@#",database="university_project")
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            messabgebox.showerror("Error","Student id must be required",parent=self.root)
        else:
            try:
    ...
    #Genarate Data set or Take Photo Sample
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="Nishu01792@#@#", database="university_project")
                my_cursor = conn.cursor()
                my_cursor.execute("Select * from student")
                ...
                ##Load Predifined daa on face frontals from opencv
